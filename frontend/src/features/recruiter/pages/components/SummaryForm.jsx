    ...
    const handleSubmit = async (e) => {
        ...
        const apiPayload = {
            company: {
                ...
                companyDescription: companyData.profile || "Pokka Singapore is a leading beverage manufacturer...",
                ...
                entityType: companyData.entityType || "Non-Governmental Organisations (NGOs)...",
                authorisedTrainingOrganisation: (companyData.ato || "Yes").toLowerCase() === "yes",
                ...
                employmentType: companyData.employmentType || "IWSP – Integrated Work Study Programme..."
            },
            user: {
                email: editableEmail,
            ...
            metadata: {
                registrationDate: signupData?.registrationDate || new Date().toISOString().split("T")[0],
        ...
        try {
            ...
            toast.success(`Registration completed successfully! Please login with ${responseEmail}`, {
                duration: 3000,
            });
            ...
            if (error.response?.status === 409) {
                toast.error("Company or user already exists. Please check your details.");
