...
export default function SummaryForm({
  ...
  const handleSubmit = (e) => {
    ...
    // Complete submission data for backend API
    const submissionData = {
      // Step 1: Company Creation Data
      company: {
      ...
      // Step 2: User Creation Data
      user: {
        email: editableEmail, // From Business Contact Info
        firstName: recruiterData.firstName || "Dave",
        lastName: recruiterData.lastName || "Johnson",
        phone: recruiterData.mobileNumber || "98646153",
        gender: gender, // From Business Contact Info
        userType: 2, // 2 = recruiter
        password: signupData.password || "",
      },

      // Step 3: Recruiter Creation Data
      recruiter: {
